...
parser.add_argument('in_file_path', type=str, help='Path to the CSV file containing ID, name and image file path accessible by this script')
parser.add_argument('out_file_path', type=str, help='Path for the output CSV with the base64')
...
with open(args.in_file_path) as csvfile:
	...
	for row in reader:
		...
		try:
			...
			print; print "Could not find the image '%s' - please make sure it is accessible to this script" % product_file_path; print
